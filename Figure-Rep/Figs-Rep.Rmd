...
p <- ggplot(df %>% arrange(nb_clusters),
  ...
  theme_classic() +
  facet_wrap(~clustering_name, scales = "free_x") +
...
p
ggsave(plot = p, filename = here("Figure-Rep", "figures", "example.png"),
       bg = "transparent")
```
