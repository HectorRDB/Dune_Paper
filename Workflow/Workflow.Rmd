...
library(knitr)
opts_chunk$set(fig.pos = "!h", out.extra = "",fig.align = "center", eval = F,
...
```{r}
ConfusionPlot(x = sce$label, y = sce$seurat_scvi_final) +
  labs(x = "Original cluster labels from the publication",
       y = "Clustering results obtained after running Dune")
```
